...
#https://github.com/prakashr1984/deep-rl/blob/master/ddpg.py
#https://github.com/openai/maddpg/issues/9
...
#https://www.tensorflow.org/api_docs/python/tf/contrib/distributions/RelaxedOneHotCategorical
#https://github.com/shariqiqbal2810/maddpg-pytorch/blob/master/algorithms/maddpg.py
#https://github.com/bogiebro/traffic-pathgrad/blob/master/gumbel.py
